...
class FillPermissionsForFooterLink extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFooterLink constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.footer-link',
            'admin.footer-link.index',
            'admin.footer-link.create',
            'admin.footer-link.show',
            'admin.footer-link.edit',
            'admin.footer-link.delete',
            'admin.footer-link.bulk-delete',
        ]);
