...
class FillPermissionsForFooterTitle extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFooterTitle constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.footer-title',
            'admin.footer-title.index',
            'admin.footer-title.create',
            'admin.footer-title.show',
            'admin.footer-title.edit',
            'admin.footer-title.delete',
            'admin.footer-title.bulk-delete',
        ]);
