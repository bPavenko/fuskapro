...
class FillPermissionsForApplicationsLink extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForApplicationsLink constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.applications-link.index',
            'admin.applications-link.create',
            'admin.applications-link.show',
            'admin.applications-link.edit',
            'admin.applications-link.delete',
            'admin.applications-link.bulk-delete',
        ]);
