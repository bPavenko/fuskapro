...
class FillPermissionsForTaskCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTaskCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.task-category',
            'admin.task-category.index',
            'admin.task-category.create',
            'admin.task-category.show',
            'admin.task-category.edit',
            'admin.task-category.delete',
            'admin.task-category.bulk-delete',
        ]);
