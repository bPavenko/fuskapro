...
class FillPermissionsForAdminReviewer extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdminReviewer constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.admin-reviewer.index',
            'admin.admin-reviewer.create',
            'admin.admin-reviewer.show',
            'admin.admin-reviewer.edit',
            'admin.admin-reviewer.delete',
            'admin.admin-reviewer.bulk-delete',
        ]);
