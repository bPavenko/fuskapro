...
class FillPermissionsForTaskSection extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTaskSection constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.task-section',
            'admin.task-section.index',
            'admin.task-section.create',
            'admin.task-section.show',
            'admin.task-section.edit',
            'admin.task-section.delete',
            'admin.task-section.bulk-delete',
        ]);
